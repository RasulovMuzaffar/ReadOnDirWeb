                        ...
                        function getDataAbstaraction(val, callback) {
                            var data = {
                                ...
                                1: {
                                    ...
                                    'pf6': 'ПФ6 - Передача ваг. с разл.по стыку Истыклол',
                                    'pf7': 'ПФ7 - Передача вагонов с расположением по СНГ по стыку Кудукли',
                                    'pf8': 'ПФ8 - Перечень принятых и сданных поездов по стыкам Учкурган',
                                    'pf9': 'ПФ9 - Перечень принятых и сданых поездов по стыку Ходжадавлет',
                                    'pf10': 'ПФ10 - Перечень чужих вагонов на ст. по времени нахож-ия на дор.',
                                    'pf11': 'ПФ11 - Подход и работа с поездами по ст. Сарыагач',
                                    'pf12': 'ПФ12 - Подход к ст. Асака',
                                    'pf13': 'ПФ13 - Подход наличие поездов по ст.Арысь',
                                    'pf14': 'ПФ14 - Подход поездов к стыку Бекабад',
                                    'pf15': 'ПФ15 - Пономерное наличие чужих вг.',
                                    'pf16': 'ПФ16 - Работа и налич поездов по ст. Джала-Абад',
                                    'pf17': 'ПФ17 - Работа ст. с поездами'
                                },
                                2: {
